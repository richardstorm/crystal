...
class CTextFilter
{
   ...
   * Properties
   */
  public static $instance = null;   // To use with Purify()
  ...
  public function doFilter($text, $filters)
  {
      ...
      foreach ($filter as $key) {
          ...
          if (isset($callbacks[$key])) {
              ...
              throw new \Exception("The filter '$key' is not a valid filter string.");
          }
      }
  ...
  /**
   * Shortcode to do quicker format text as HTML.
   *
   * @param string $text text to be converted.
   *
   * @return string the formatted text.
